...
#define GPIO_GPS_UART_RXD		__NC__ //S5PV210_GPA0(4)
#define GPIO_GPS_UART_RXD_AF	2

#define GPIO_GPS_UART_TXD		__NC__ // S5PV210_GPA0(5)
#define GPIO_GPS_UART_TXD_AF	2

#define GPIO_GPS_UART_CTS		__NC__ //S5PV210_GPA0(6)
#define GPIO_GPS_UART_CTS_AF	2

#define GPIO_MSENSE_nRST       S5PV210_GPA0(6)

#define GPIO_GPS_UART_RTS		__NC__ //S5PV210_GPA0(7)
...
#define GPIO_AP_FLM_RXD			__NC__ //S5PV210_GPA1(2)
#define GPIO_AP_FLM_RXD_AF		2

#define GPIO_AP_FLM_TXD			__NC__ //S5PV210_GPA1(3)
...
//#define GPIO_BT_nRST			__NC__ //S5PV210_GPB(3)
...
#define GPIO_REC_PCM_CLK		__NC__ //S5PV210_GPC0(0)
...
#define GPIO_REC_PCM_SYNC		__NC__ //S5PV210_GPC0(2)
#define GPIO_REC_PCM_SYNC_AF	3
#define GPIO_FM33_SDA			S5PV210_GPC0(2)

#define GPIO_REC_PCM_IN			__NC__ //S5PV210_GPC0(3)
#define GPIO_REC_PCM_IN_AF		3
#define     GPIO_DISPLAY_DAT    S5PV210_GPC0(3)

#define GPIO_REC_PCM_OUT		__NC__ //S5PV210_GPC0(4)
#define GPIO_REC_PCM_OUT_AF		3

#define     GPIO_MLCD_RST		S5PV210_GPC0(4)
#define BLOW_PCM_CLK			__NC__ //S5PV210_GPC1(0)
...
#define GPIO_VIBTONE_PWM1		__NC__ //S5PV210_GPD0(2)
...
#define GPIO_FM_SDA_28V			__NC__ //S5PV210_GPD1(2)
#define GPIO_FM_SDA_28V_AF		2
#define GPIO_HDMI_SDA_28		S5PV210_GPD1(2)

#define GPIO_FM_SCL_28V			__NC__ //S5PV210_GPD1(3)
...
#define GPIO_GPS_nRST			__NC__ //S5PV210_GPG3(0)

#define GPIO_GPS_PWR_EN			__NC__ //S5PV210_GPG3(1)

#define GPIO_GPS_CLK_INT		__NC__ //S5PV210_GPG3(2)
...
#define GPIO_C110_DPRAM_INT_N		S5PV210_GPH1(0)
...
#define GPIO_KBC2				__NC__ //S5PV210_GPH2(2)
...
#define GPIO_MSENSE_IRQ			__NC__ //S5PV210_GPH3(5)
...
#define GPIO_USB_SW_EN			S5PV210_GPJ2(0)

#define GPIO_CAM_FLASH_SET		__NC__ //S5PV210_GPJ2(1)
#define GPIO_UART_SEL1			S5PV210_GPJ2(1)

#define GPIO_OLED_DET			__NC__ //S5PV210_GPJ2(2)
#define GPIO_VIA_PS_HOLD_OFF	S5PV210_GPJ2(2)

#define GPIO_CODEC_XTAL_EN		__NC__ //S5PV210_GPJ2(3)
#define GPIO_BOOT_MODE			S5PV210_GPJ2(3)

#define GPIO_FM_INT				__NC__ //S5PV210_GPJ2(4)
#define GPIO_MICBIAS_EN1		S5PV210_GPJ2(4)
#define GPIO_FM_RST				__NC__ //S5PV210_GPJ2(5)
#define GPIO_PDA_ACTIVE			S5PV210_GPJ2(5)

#define GPIO_EARPATH_SEL		__NC__//S5PV210_GPJ2(6)
//#define GPIO_CAM_IO_EN		S5PV210_GPJ2(6)

#define GPIO_MASSMEMORY_EN		S5PV210_GPJ2(7)

#define _3_TOUCH_SDA_28V		__NC__ //		S5PV210_GPJ3(0)
#define _3_TOUCH_SCL_28V				S5PV210_GPJ3(1)
#define _3_GPIO_TOUCH_EN		__NC__ //	S5PV210_GPJ3(2)
#define _3_GPIO_TOUCH_EN_AF		1
#define _3_GPIO_TOUCH_CE		__NC__ //		S5PV210_GPJ3(3)
...
#define GPIO_TV_EN				__NC__ //S5PV210_GPJ4(4)
...
//#define GPIO_PDA_ACTIVE			__NC__ //S5PV210_MP03(3)
...
//#define GPIO_DISPLAY_CLK		__NC__ //S5PV210_MP04(1)
#define GPIO_DISPLAY_CLK_AF		__NC__ //S3C_GPIO_SFN(1)

#define GPIO_MP042				__NC__ //S5PV210_MP04(2)

#define GPIO_DISPLAY_SI			__NC__ //S5PV210_MP04(3)
#define GPIO_DISPLAY_SI_AF		__NC__ //S3C_GPIO_SFN(1)

#define GPIO_MP044				__NC__ //S5PV210_MP04(4)

#define GPIO_LVDS_RST			__NC__ //S5PV210_MP04(5)

#define GPIO_GPS_CLK_EN			__NC__ //S5PV210_MP04(6)

#define GPIO_MHL_RST			__NC__ //S5PV210_MP04(7)

#define FUEL_SCL_18V		__NC__ //S5PV210_MP05(0)
#define FUEL_SDA_18V	__NC__ //S5PV210_MP05(1)

//#define GPIO_AP_SCL_18V			__NC__ //S5PV210_MP05(2)

//#define GPIO_AP_SDA_18V			__NC__ //S5PV210_MP05(3)

#define GPIO_MP054				__NC__ //S5PV210_MP05(4)

//#define GPIO_MLCD_RST			__NC__ //S5PV210_MP05(5)
...
#define AP_I2C_SDA              __NC__ //S5PV210_MP05(3)
#define AP_I2C_SCL              __NC__ //S5PV210_MP05(2)
#define AP_I2C_SDA_28V			__NC__ //S5PV210_GPJ3(6)
#define	AP_I2C_SCL_28V			__NC__ //S5PV210_GPJ3(7)

#define PMIC_I2C_SDA            __NC__ //S5PV210_GPJ4(0)
#define PMIC_I2C_SCL            __NC__ //S5PV210_GPJ4(3)

//#define GPIO_TOUCH_INT			__NC__ //S5PV210_GPJ0(5)
#define	GPIO_TOUCH_INT_AF		0xFF

#define	GPIO_TOUCH_RST			__NC__ //S5PV210_GPB(6)
