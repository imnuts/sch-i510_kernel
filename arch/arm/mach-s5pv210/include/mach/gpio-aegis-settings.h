...
//	{S5PV210_GPA1(1), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN},
	...
	{S5PV210_GPB(6),  S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ONE,  S3C_GPIO_PULL_NONE},
...
//	{S5PV210_GPC0(4), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN},
	...
	{S5PV210_GPJ2(1), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE},
...
static unsigned int sleep_gpio_table[][3] =
{
	...
	{S5PV210_GPA0(4), S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_NONE},	//NC
	{S5PV210_GPA0(5), S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_NONE},	//NC
	{S5PV210_GPA0(6), S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_NONE},	//MSENSE_nRST
	{S5PV210_GPA0(7), S3C_GPIO_SLP_OUT1,  S3C_GPIO_PULL_NONE},	//VOLUME_UP
	...
	{S5PV210_GPA1(3), S3C_GPIO_SLP_OUT1,  S3C_GPIO_PULL_NONE},	//GPIO_RST
	...
	{S5PV210_GPB(4),  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE},	//VIA_USB_OFF
	{S5PV210_GPB(5),  S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_NONE},	//BT_EN
	{S5PV210_GPB(6),  S3C_GPIO_SLP_OUT1,  S3C_GPIO_PULL_NONE},	//NC
	{S5PV210_GPB(7),  S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE},	//NC
	...
	// GPC1 -------------------------------------------------
	{S5PV210_GPC1(0), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},	//VT_CAM_SDA_1.8V
	{S5PV210_GPC1(1), S3C_GPIO_SLP_OUT1,  S3C_GPIO_PULL_NONE},	//GPS_nRST
	{S5PV210_GPC1(2), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},	//NC
	{S5PV210_GPC1(3), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},	//VT_CAM_SCL_1.8V
	{S5PV210_GPC1(4), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},	//GPS_EN

	// GPD0 -------------------------------------------------
	{S5PV210_GPD0(0), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},	//TOUCHKEY_LED_EN
	{S5PV210_GPD0(1), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},	//GPIO_VIBTONE_PWM
	{S5PV210_GPD0(2), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},	//GPIO_FLASH_EN
	{S5PV210_GPD0(3), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},	//GPIO_FLASH_SET

	// GPD1 -------------------------------------------------
	{S5PV210_GPD1(0), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE},	//SC_SDA_2.8V
	{S5PV210_GPD1(1), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE},	//SC_SCL_2.8V
	{S5PV210_GPD1(2), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE},	//GPIO_SDA
	{S5PV210_GPD1(3), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE},	//GPIO_SCL
	...
	{S5PV210_GPE1(4), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},	//CAM_VGA_nRST
	...
	// GPG3 -------------------------------------------------
	{S5PV210_GPG3(0), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},	//TOUCHKEY_SCL
	{S5PV210_GPG3(1), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},	//NC
	{S5PV210_GPG3(2), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},	//TOUCHKEY_SDA
	...
	{S5PV210_GPG3(5), S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_NONE},	//WLAN_EN
	...
	{S5PV210_GPJ0(6), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},	//TOUCHKEY_INT
	{S5PV210_GPJ0(7), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_NONE},	//GPIO_HWREV_MODE3

	// GPJ1 -------------------------------------------------
	{S5PV210_GPJ1(0), S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_NONE},	//EVDO_PWR_EN
	...
	// GPJ2 -------------------------------------------------
	{S5PV210_GPJ2(0), S3C_GPIO_SLP_PREV,  S3C_GPIO_PULL_NONE},	//SUB_MICBIAS_EN
	...
	{S5PV210_GPJ2(6), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},	//TOUCHKEY_VDD_EN
	{S5PV210_GPJ2(7), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},	//GPIO_MASSMEMORY_EN

	// GPJ3 -------------------------------------------------
	{S5PV210_GPJ3(0), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN},	//OLED_DET_2.8V
	...
	{S5PV210_GPJ4(4), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},	//SC_DISABLE
	...
	{S5PV210_MP01(5), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},	//CAM_MEGA_nRST
...
//	{S5PV210_GPH1(7), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_NONE}, //PHONE_ACTIVE
	...
	{S5PV210_GPH2(2), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, //OPEN_SEND_END
