...
#define GPS_UART_RXD_2_8V			S5PV210_GPA0(4)

#define GPS_UART_TXD_2_8V			S5PV210_GPA0(5)

#define GPIO_MSENSE_nRST       		S5PV210_GPA0(6)

#define GPIO_MSENSE_nRST_REV05		S5PV210_GPB(6)
...
#define GPIO_RST			S5PV210_GPA1(3)
...
#define VIA_USB_OFF				S5PV210_GPB(4)

#define GPIO_WLAN_BT_EN		S5PV210_GPB(5)

#define GPIO_SC_STAT		S5PV210_GPB(7)
...
#define GPIO_VT_CAM_SDA_18V		S5PV210_GPC1(0)

#define GPS_nRST				S5PV210_GPC1(1)

#define GPIO_VT_CAM_SCL_18V		S5PV210_GPC1(3)

#define GPS_EN					S5PV210_GPC1(4)

#define TOUCHKEY_LED_EN		S5PV210_GPD0(0)

#define GPIO_VIBTONE_PWM		S5PV210_GPD0(1)

#define GPIO_CAM_FLASH_SET			S5PV210_GPD0(2)

#define GPIO_CAM_FLASH_EN		S5PV210_GPD0(3)

#define CAM_FLASH_SET			S5PV210_GPD0(3)

#define GPIO_SC_SDA_28V			S5PV210_GPD1(0)

#define GPIO_SC_SCL_28V			S5PV210_GPD1(1)

#define GPIO_SDA				S5PV210_GPD1(2)

#define GPIO_SCL					S5PV210_GPD1(3)
...
#define TOUCHKEY_I2C_SCL			S5PV210_GPG3(0)

#define TOUCHKEY_I2C_SDA			S5PV210_GPG3(2)
...
#define GPIO_WLAN_EN			S5PV210_GPG3(5)
...
#define GPIO_HALL_SW			S5PV210_GPH1(4)
...
#define GPIO_INT				S5PV210_GPH3(0)
#define GPIO_INT_AF		0xF
	
#define VOL_UP			S5PV210_GPH3(1)

#define VOL_DOWN		S5PV210_GPH3(2)
...
#define _3_GPIO_TOUCH_INT			S5PV210_GPJ0(6)
...
#define GPIO_SUB_MICBIAS_EN			S5PV210_GPJ2(0)
...
#define TOUCHKEY_VDD_EN			S5PV210_GPJ2(6)

#define GPIO_MASSMEMORY_EN		S5PV210_GPJ2(7)

#define GPIO_OLED_DET			S5PV210_GPJ3(0)

#define FUEL_SCL_18V			S5PV210_GPJ3(1)

#define FUEL_SDA_18V			S5PV210_GPJ3(2)

#define GPIO_USB_SW_EN1			S5PV210_GPJ3(3)
...
#define SC_DISABLE 		S5PV210_GPJ4(4)
...
#define GPIO_CAM_MEGA_nRST			S5PV210_MP01(5)

#define GPIO_CAM_SCL_18V			S5PV210_MP02(3)

#define GPIO_CAM_SDA_18V			S5PV210_MP03(3)
