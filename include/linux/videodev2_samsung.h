...
#define V4L2_CID_FW_UPDATE                                    (V4L2_CID_PRIVATE_BASE + 61)  

#define V4L2_CID_CAM_DATE_INFO_YEAR           	       (V4L2_CID_PRIVATE_BASE + 62)
#define V4L2_CID_CAM_DATE_INFO_MONTH           	(V4L2_CID_PRIVATE_BASE + 63)
#define V4L2_CID_CAM_DATE_INFO_DATE1                 (V4L2_CID_PRIVATE_BASE + 64)
#define V4L2_CID_CAM_DATE_INFO_DATE2                 (V4L2_CID_PRIVATE_BASE + 65)
#define V4L2_CID_CAM_MODULE_VER                         (V4L2_CID_PRIVATE_BASE + 68)
#define V4L2_CID_CAM_MODULE_COMP                      (V4L2_CID_PRIVATE_BASE + 69)
...
#define V4L2_CID_CAMERA_SENSOR_MODE					(V4L2_CID_PRIVATE_BASE+115)
#define V4L2_CID_CAMERA_FLASH_CHECK					(V4L2_CID_PRIVATE_BASE+116)
#define V4L2_CID_CAMERA_GET_SHT_TIME_NUM			(V4L2_CID_PRIVATE_BASE+117)
#define V4L2_CID_CAMERA_GET_SHT_TIME_DEN		(V4L2_CID_PRIVATE_BASE+118)
#define V4L2_CID_CAMERA_GET_TV_NUM				(V4L2_CID_PRIVATE_BASE+119)
#define V4L2_CID_CAMERA_GET_TV_DEN				(V4L2_CID_PRIVATE_BASE+120)
#define V4L2_CID_CAMERA_GET_AV_NUM				(V4L2_CID_PRIVATE_BASE+121)
#define V4L2_CID_CAMERA_GET_AV_DEN				(V4L2_CID_PRIVATE_BASE+122)
#define V4L2_CID_CAMERA_GET_BV_NUM				(V4L2_CID_PRIVATE_BASE+123)
#define V4L2_CID_CAMERA_GET_BV_DEN				(V4L2_CID_PRIVATE_BASE+124)
#define V4L2_CID_CAMERA_GET_EBV_NUM				(V4L2_CID_PRIVATE_BASE+125)
#define V4L2_CID_CAMERA_GET_EBV_DEN				(V4L2_CID_PRIVATE_BASE+126)
#define V4L2_CID_CAMERA_EV_PROGRAM_MODE			(V4L2_CID_PRIVATE_BASE+127) 
#define V4L2_CID_CAMERA_MCC_MODE					(V4L2_CID_PRIVATE_BASE+128) 

#define V4L2_CID_CAMCORER_MODE                               (V4L2_CID_PRIVATE_BASE+130) 
#define V4L2_CID_CAM_S_FW_VER                                   (V4L2_CID_PRIVATE_BASE + 131)
