...
#define MCSDL_CE_SET_OUTPUT()   	        		s3c_gpio_cfgpin(GPIO_TOUCH_EN, S3C_GPIO_OUTPUT);\
...
#define MCSDL_RESETB_SET_OUTPUT()           		//s3c_gpio_setpull(GPIO_TOUCH_INT,S3C_GPIO_PULL_NONE);\
																//s3c_gpio_cfgpin(GPIO_TOUCH_INT, S3C_GPIO_OUTPUT)
//Mcsdl_Resetb_Int_Set_Output()
#define MCSDL_RESETB_SET_INPUT()            		gpio_direction_input(GPIO_TOUCH_INT)
//Mcsdl_Resetb_Int_Set_Input()
#else
...
#define MCSDL_GPIO_SCL_SET_OUTPUT()					//not needed
#define MCSDL_GPIO_SCL_SET_INPUT()					gpio_direction_input(GPIO_TOUCH_I2C_SCL)
#define MCSDL_GPIO_SDA_SET_OUTPUT()					//not needed
