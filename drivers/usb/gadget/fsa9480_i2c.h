...
#define DEBUG_FSA9480(fmt,args...) printk(KERN_ERR "uUsb:" fmt, ##args)
#define LOGD(fmt,args...) printk(KERN_ERR "fsa:%s:" fmt, __func__, ##args)
#else
...
//-- change the USB_SW_CP and AP because, param Switch Sel  UART bit 0 is CP
...
struct FSA9480_STATUS {
	unsigned int cable_state;
	u8 adc;
};

struct line_status_t {
	enum FSA_LINE_STATUS 	line; //USB or UART
	enum FSA_JIG_STATUS	jig;  //JIG or BOOT on/off
	unsigned int	 	usb_func;
	unsigned int		usb_func_prev;
	unsigned int 		switch_sel;
	unsigned int 		factoryreset;
	enum SWITCH_PATH 	uart_path;
	enum SWITCH_PATH	usb_path;
	struct FSA9480_STATUS  	fsa_status;	//SWITCH CHIP
	unsigned int		uart_debug_enable;
};

/* switch selection */
#define USB_SEL_BIT  			0	// 0000 0000 0000 0011
#define UART_SEL_BIT			2	// 0000 0000 0000 1100

#define USB_UMS_BIT				4	// 0000 0000 0001 0000
#define USB_SAMSUNG_KIES_BIT	5	// 0000 0000 0010 0000
#define USB_MTP_BIT				6	// 0000 0000 0100 0000
#define USB_ASKON_BIT			7	// 0000 0000 1000 0000
#define USB_VTP_BIT				8	// 0000 0001 0000 0000
#define USB_ADB_BIT				9	// 0000 0010 0000 0000
#define USB_DM_BIT				10	// 0000 0100 0000 0000
#define USB_ACM_BIT				11	// 0000 1000 0000 0000

#define UART_DEBUG_BIT			23	

#define USB_BIT_START			(USB_UMS_BIT)
#define USB_FUNC_MAX			8	// num of usb fuctions

#define B2S(bit)				(0x1<<(bit-USB_BIT_START-1))
#define B2M(bit) 				(0x1 << bit)


#define USB_SEL_MASK  			(3 << USB_SEL_BIT)
#define UART_SEL_MASK			(3 << UART_SEL_BIT)

#define USB_SAMSUNG_KIES_MASK	B2M(USB_SAMSUNG_KIES_BIT)
#define USB_UMS_MASK			B2M(USB_UMS_BIT)
#define USB_MTP_MASK			B2M(USB_MTP_BIT)
#define USB_VTP_MASK			B2M(USB_VTP_BIT)
#define USB_ASKON_MASK			B2M(USB_ASKON_BIT)

#define UART_DEBUG_MASK			B2M(UART_DEBUG_BIT)

/*usb function bit masks*/
#define USBSTATUS_UMS			B2S(USB_UMS_BIT)
#define USBSTATUS_SAMSUNG_KIES	B2S(USB_SAMSUNG_KIES_BIT)
#define USBSTATUS_MTPONLY 		B2S(USB_MTP_BIT)
#define USBSTATUS_ASKON 		B2S(USB_ASKON_BIT)
#define USBSTATUS_VTP			B2S(USB_VTP_BIT)
#define USBSTATUS_ADB			B2S(USB_ADB_BIT)
#define USBSTATUS_DM			B2S(USB_DM_BIT)
#define USBSTATUS_ACM			B2S(USB_ACM_BIT)

#define DRIVER_NAME_UMS  "usb_mass_storage"
