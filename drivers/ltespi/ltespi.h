...
** Ported from oneDRAM driver of ARIES??. 
...
/* 32KB Size */
#define DPRAM_SIZE										0x9800		// 0x8000

/* Memory Address */
#define DPRAM_START_ADDRESS 							0x0000
#define DPRAM_MAGIC_CODE_ADDRESS						(DPRAM_START_ADDRESS)									// 0x0000 0000
#define DPRAM_ACCESS_ENABLE_ADDRESS					(DPRAM_START_ADDRESS + 0x0002)

#define DPRAM_PDA2PHONE_FORMATTED_START_ADDRESS	(DPRAM_START_ADDRESS + 0x0004)							// 0x0000 0004
#define DPRAM_PDA2PHONE_FORMATTED_HEAD_ADDRESS		(DPRAM_PDA2PHONE_FORMATTED_START_ADDRESS)				// 0x0000 0004
#define DPRAM_PDA2PHONE_FORMATTED_TAIL_ADDRESS		(DPRAM_PDA2PHONE_FORMATTED_START_ADDRESS + 0x0002)		// 0x0000 0006
#define DPRAM_PDA2PHONE_FORMATTED_BUFFER_ADDRESS	(DPRAM_PDA2PHONE_FORMATTED_START_ADDRESS + 0x0004)		// 0x0000 0008
#define DPRAM_PDA2PHONE_FORMATTED_BUFFER_SIZE		0xFFC		//4092

#define DPRAM_PDA2PHONE_RAW_START_ADDRESS			(DPRAM_PDA2PHONE_FORMATTED_START_ADDRESS + (DPRAM_PDA2PHONE_FORMATTED_BUFFER_SIZE+4))
#define DPRAM_PDA2PHONE_RAW_HEAD_ADDRESS			(DPRAM_PDA2PHONE_RAW_START_ADDRESS)				// 0x0000 1004
#define DPRAM_PDA2PHONE_RAW_TAIL_ADDRESS			(DPRAM_PDA2PHONE_RAW_START_ADDRESS + 2)			// 0x0000 1006
#define DPRAM_PDA2PHONE_RAW_BUFFER_ADDRESS			(DPRAM_PDA2PHONE_RAW_START_ADDRESS + 4)			// 0x0000 1008
#define DPRAM_PDA2PHONE_RAW_BUFFER_SIZE				0x3BF0	// 15344

#define DPRAM_PHONE2PDA_FORMATTED_START_ADDRESS	(DPRAM_PDA2PHONE_RAW_START_ADDRESS + (DPRAM_PDA2PHONE_RAW_BUFFER_SIZE+4))
#define DPRAM_PHONE2PDA_FORMATTED_HEAD_ADDRESS		(DPRAM_PHONE2PDA_FORMATTED_START_ADDRESS)				// 0x0000 4BF8
#define DPRAM_PHONE2PDA_FORMATTED_TAIL_ADDRESS		(DPRAM_PHONE2PDA_FORMATTED_START_ADDRESS + 0x0002)		// 0x0000 4BFA
#define DPRAM_PHONE2PDA_FORMATTED_BUFFER_ADDRESS	(DPRAM_PHONE2PDA_FORMATTED_START_ADDRESS + 0x0004) 	// 0x0000 4BFC
#define DPRAM_PHONE2PDA_FORMATTED_BUFFER_SIZE		0xFFC		//4092


#define DPRAM_PHONE2PDA_RAW_START_ADDRESS			(DPRAM_PHONE2PDA_FORMATTED_START_ADDRESS + (DPRAM_PHONE2PDA_FORMATTED_BUFFER_SIZE+4))
#define DPRAM_PHONE2PDA_RAW_HEAD_ADDRESS			(DPRAM_PHONE2PDA_RAW_START_ADDRESS)				// 0x0000 5BF8
#define DPRAM_PHONE2PDA_RAW_TAIL_ADDRESS			(DPRAM_PHONE2PDA_RAW_START_ADDRESS + 0x0002)		// 0x0000 5BFA
#define DPRAM_PHONE2PDA_RAW_BUFFER_ADDRESS			(DPRAM_PHONE2PDA_RAW_START_ADDRESS + 0x0004)		// 0x0000 5BFC
#define DPRAM_PHONE2PDA_RAW_BUFFER_SIZE				0x3BF0	// 15344					
																													//0x0000 97EC
