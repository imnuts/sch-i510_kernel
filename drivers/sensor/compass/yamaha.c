...
//2010.09.09 jinho96.kim
#define YAMAHA_GSENSOR_TRANSFORMATION_REAL01_PREP1    \
    { { 1,  0,  0}, \
      { 0, 1 ,  0}, \
      { 0,  0,  -1} }
	      ...
	      unsigned int cmd, unsigned long arg)
{
	...
	//2010.09.09 jinho96.kim
	signed char garray_real01_prep1[3][3] = YAMAHA_GSENSOR_TRANSFORMATION_REAL01_PREP1;
	if( (HWREV == 5) || (HWREV==6) || (HWREV>=8))
	{
		printk("[YAMAHA] YAMAHA_GSENSOR_TRANSFORMATION_REAL01_PREP1 size of = %d\n",sizeof(garray_real01_prep1));
		
		memcpy((void*)garray,(void*)garray_real01_prep1,sizeof(garray_real01_prep1));
	}
	else
	{
		printk("[YAMAHA] YAMAHA_GSENSOR_TRANSFORMATION_REV%02d\n",HWREV-1);	
	}
